...
def startScreen():
        ...
        font = pygame.font.Font(os.path.join("assets", "fonts", "Ethnocentric.ttf"), 30)
        SR_text_image = font.render("Session Runtime: 0:00", True, values.COLOR_White)
        screen.blit(SR_text_image , (10, 10))
        
        
        
        #if mouse is over stat, change color to white
        if pygame.mouse.get_pos()[0] > 10 and pygame.mouse.get_pos()[0] < 160 and pygame.mouse.get_pos()[1] > 60 and pygame.mouse.get_pos()[1] < 90:
        ...
        if pygame.mouse.get_pos()[0] > 820 and pygame.mouse.get_pos()[0] < 1090 and pygame.mouse.get_pos()[1] > 750 and pygame.mouse.get_pos()[1] < 800:
