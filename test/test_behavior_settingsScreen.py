...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Change Name')
...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Change Master Volume')
@given('the player is on the settings screen')
def test_settings_Screen():
    pygame.init()
    # Make game full screen
...
def test_change_master_volume():
    ...
    pass_variable = settingsS.checkSliderCords(left, factor, image, screen, range,
                                          height)
...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Change Music Volume')
@given('the player is on the settings screen')
def test_settings_Screen():
    pygame.init()
    # Make game full screen
...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Change SFX Volume')
def test_settings_Screen():
    pygame.init()
    # Make game full screen
    pygame.display.set_mode((0, 0), pygame.FULLSCREEN)
...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Change Difficulty Easy')
def test_settings_Screen():
    pygame.init()
    # Make game full screen
    pygame.display.set_mode((0, 0), pygame.FULLSCREEN)
...
def test_change_difficulty_easy():
    ...
    mouse_cords = (easydifficultySettingCords[0] + 1, easydifficultySettingCords[1] + 1)
    pygame.mouse.set_pos(mouse_cords)
    pass_variable = settingsS.checkDifCords(easydifficultySettingCords, easy_image)
...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Change Difficulty Medium')
def test_settings_Screen():
    pygame.init()
    # Make game full screen
    pygame.display.set_mode((0, 0), pygame.FULLSCREEN)
...
def test_change_difficulty_medium():
    ...
    mouse_cords = (mediumdifficultySettingCords[0] + 1, mediumdifficultySettingCords[1] + 1)
    pygame.mouse.set_pos(mouse_cords)
    pass_variable = settingsS.checkDifCords(mediumdifficultySettingCords, medium_image)
...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Change Difficulty Hard')
def test_settings_Screen():
    pygame.init()
    # Make game full screen
    pygame.display.set_mode((0, 0), pygame.FULLSCREEN)
...
def test_change_difficulty_hard():
    ...
    mouse_cords = (harddifficultySettingCords[0] + 1, harddifficultySettingCords[1] + 1)
    pygame.mouse.set_pos(mouse_cords)
    pass_variable = settingsS.checkDifCords(harddifficultySettingCords, hard_image)
...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Change Input Wasd')
@given('the player is on the settings screen')
def test_settings_Screen():
    pygame.init()
    # Make game full screen
...
def test_change_input_wasd():
    ...
    wasdSettingCords = (left + 30 + widthButton,
...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Change Input Arrows')
@given('the player is on the settings screen')
def test_settings_Screen():
    pygame.init()
    # Make game full screen
...
@scenario('../test/features/settingsScreen.feature', 'Setting Screen - Help Button')
def test_settings_Screen():
    pygame.init()
    # Make game full screen
    pygame.display.set_mode((0, 0), pygame.FULLSCREEN)
...
def test_click_help_button():
    ...
    right = screen.get_width() / 4 * 3
    widthButton = (right - left - 40) / 3
    helpSettingCords = (left + 30 + widthButton,
                        screen.get_height() / 16 * 13)
