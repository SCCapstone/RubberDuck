...
scenario('../test/features/highScoreScreen.feature', 'High Score Screen - Play Button')
...
scenario('../test/features/highScoreScreen.feature', 'High Score Screen - Home Button')
@given('I am on the High Score screen')
def test_highScore_Screen():
    settingIO.load_settings(values.SETTING_PATH)
...
@scenario('../test/features/highScoreScreen.feature', 'High Score Screen - Share Button')
@given('I am on the High Score screen') 
def test_highScore_Screen():
    settingIO.load_settings(values.SETTING_PATH)
