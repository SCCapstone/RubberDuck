...
scenario('../test/features/gameOverScreen.feature', 'Clicking "Home"')
...
scenario('../test/features/gameOverScreen.feature', 'Clicking "New Game"')
...
scenario('../test/features/gameOverScreen.feature', 'Clicking "Share Score"')
